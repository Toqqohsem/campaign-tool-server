...
exports.adCopyRoutes.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (campaign_id) {
            adCopy = adCopy.filter(a => a.campaign_id === campaign_id);
        }
        if (persona_id) {
            adCopy = adCopy.filter(a => a.persona_id === persona_id);
        }
        res.json(adCopy);
    }
    catch (err) {
...
exports.adCopyRoutes.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        mockAdCopy[adCopyIndex] = Object.assign(Object.assign({}, mockAdCopy[adCopyIndex]), { headline,
